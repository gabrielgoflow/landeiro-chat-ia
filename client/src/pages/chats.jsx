...
import { import { useEffect, useState } from 'react'
        ...
        export default function ChatsPage() {
          ...
          userChats.forEach(chat => {
            if (!latestThreads[chat.thread_id] || chat.sessao > latestThreads[chat.thread_id].sessao) {
                ...
                {chatsToShow.length === 0 ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {chatsToShow.map((chat) => {
                      // Badge de status
                      const statusBadge = chat.status === 'finalizado' ? (
                            ...
                            <CardContent className="pt-0">
                              <div className="space-y-3">
                                ...
                                <div className="border-t pt-3">
                                  ...
                                  >
                                    {chat.status === 'finalizado' ? "Visualizar Supervisão" : "Continuar Conversa"}
                                  </Button>
                                </div>
                              </div>
                            </CardContent>
