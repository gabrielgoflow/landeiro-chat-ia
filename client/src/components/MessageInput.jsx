...
export function MessageInput({ onSendMessage, isLoading, error, onClearError, isFinalized = false, isSessionExpired = false, isPaused = false }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!message.trim() || isLoading || isPaused) return;
